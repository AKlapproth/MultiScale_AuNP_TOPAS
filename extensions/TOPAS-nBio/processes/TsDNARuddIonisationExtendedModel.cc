    ...
    :G4VEmModel(nam),isInitialised(false)
{
    ...
    if( verboseLevel>0 )
    {
        G4cout << "Ts Rudd ionisation model is constructed " << G4endl;
    }
                                                  ...
                                                  const G4DataVector& /*cuts*/)
{
    ...
    highEnergyLimit[proton] = 1000 * MeV; //500. * keV;
    ...
    highEnergyLimit[hydrogen] = 1000 * MeV; //100. * MeV;
    ...
    highEnergyLimit[alphaPlusPlus] = 4000 * MeV; //400. * MeV;
    ...
    highEnergyLimit[alphaPlus] = 4000 * MeV; //400. * MeV;
